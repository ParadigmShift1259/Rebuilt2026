...
//    private final Transform2d ROBOT_TO_QUEST = new Transform2d(-0.22, 0.225, Rotation2d.k180deg); // Robot 1
    private final Transform2d ROBOT_TO_QUEST = new Transform2d(-0.24, -0.35, new Rotation2d(-3.0 * Math.PI / 4)); // Robot 2
